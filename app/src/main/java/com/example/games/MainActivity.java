        ...
        if(account != null){
            ...
            UsersRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    HeaderUserText.setText(dataSnapshot.child(mAuth.getCurrentUser().getUid()).child("name").getValue(String.class));
                }
                                    ...
                                    mAuth.createUserWithEmailAndPassword(emailaddr.getText().toString().toLowerCase().trim(),password.getText().toString().trim())
                                            .addOnCompleteListener(MainActivity.this, new OnCompleteListener<AuthResult>() {
                                                ...
                                                public void onComplete(@NonNull Task<AuthResult> task) {
                                                    if (task.isSuccessful()) {
                                                        // Sign in success, update UI with the signed-in user's information
                                                        User user=new User(username.getText().toString().trim(),emailaddr.getText().toString().trim());
